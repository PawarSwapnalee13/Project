...
namespace Etour.Migrations
{
    ...
    [Migration("20230222042829_createTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Etour.Model.Booking_Header_Master", b =>
                {
                    ...
                    b.ToTable("Booking_Header_Masters");
                });
            ...
            modelBuilder.Entity("Etour.Model.Customer_Master", b =>
                {
                    ...
                    b.Property<string>("Cust_Details")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Etour.Model.Itinerery_Master", b =>
                {
            ...
            modelBuilder.Entity("Etour.Model.Passanger_Table", b =>
                {
            ...
            modelBuilder.Entity("Etour.Model.Booking_Header_Master", b =>
                {
                    b.HasOne("Etour.Model.Customer_Master", "Customer_Masters")
                        .WithMany("Booking_Header_Master")
            ...
            modelBuilder.Entity("Etour.Model.Passanger_Table", b =>
                {
                    b.HasOne("Etour.Model.Booking_Header_Master", "Booking_Header_Master")
                        .WithMany("Passenger_Tables")
                        .HasForeignKey("Booking_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Booking_Header_Master");
                });
            ...
            modelBuilder.Entity("Etour.Model.Category_Master", b =>
                {
                    ...
                    b.Navigation("Itinerery_Masters");
