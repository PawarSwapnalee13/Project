        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cust_Details = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Booking_Header_Masters", x => x.Booking_id);
                    table.ForeignKey(
                        name: "FK_Booking_Header_Masters_Customer_Masters_Customer_MastersCust_Id",
                        column: x => x.Customer_MastersCust_Id,
                        principalTable: "Customer_Masters",
                        principalColumn: "Cust_Id");
                    table.ForeignKey(
                        name: "FK_Booking_Header_Masters_Date_Masters_Date_MastersDeparture_id",
                        column: x => x.Date_MastersDeparture_id,
                        principalTable: "Date_Masters",
                        principalColumn: "Departure_id");
                    table.ForeignKey(
                        name: "FK_Booking_Header_Masters_Package_Masters_Package_MastersPkg_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Passenger_Tables_Booking_Header_Masters_Booking_id",
                        column: x => x.Booking_id,
                        principalTable: "Booking_Header_Masters",
                        principalColumn: "Booking_id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Booking_Header_Masters_Customer_MastersCust_Id",
                table: "Booking_Header_Masters",
                column: "Customer_MastersCust_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_Header_Masters_Date_MastersDeparture_id",
                table: "Booking_Header_Masters",
                column: "Date_MastersDeparture_id");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_Header_Masters_Package_MastersPkg_id",
                table: "Booking_Header_Masters",
